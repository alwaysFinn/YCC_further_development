 ...
 * 최초 작성일 : '23.01.06
 * 마지막 업데이트 : '23.01.18
 * 업데이트 내용 : 선택한 동아리 제목에 따라 해당 동아리 페이지로 이동 및 정보들 보여주는 기능
...
public interface ClubService {
	...
	List<ClubDto> selectClubDetail(String club_title) throws Exception; // 선택한 동아리 제목에 따라 해당 동아리로 이동 및 정보들 보여줄 기능
}
